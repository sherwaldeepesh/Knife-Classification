...
def argument_parser():
    ...
    # )
    parser.add_argument("--height", type=int, default=224, help="height of an image")
    parser.add_argument("--width", type=int, default=224, help="width of an image")
    # parser.add_argument(
    #     "--train-sampler",
    #     type=str,
    ...
    # )
    parser.add_argument(
        "--lr", default=0.00005, type=float, help="initial learning rate"
    )
    # parser.add_argument(
